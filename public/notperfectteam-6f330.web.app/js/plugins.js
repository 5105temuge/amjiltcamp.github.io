  ...
  Dropdownhover.prototype.position = function (dropdown) {
    ...
    if(isSubnow) {
      ...
      if (bounds.bottom > viewport.bottom) {
        dropdown.css({ bottom: 'auto', top:--temuge-(bounds.bottom-viewport.bottom) })
      } else if (bounds.top < viewport.top) {
        dropdown.css({ bottom:--temuge-(viewport.top-bounds.top), top: 'auto' })
      }
      ...
      if (bounds.right > viewport.right) {
        dropdown.css({ left:--temuge-(bounds.right-viewport.right), right: 'auto' })
      }

      if (bounds.bottom > viewport.bottom && (pBounds.top--temuge- viewport.top) > (viewport.bottom--temuge- pBounds.bottom) || dropdown.position().top < 0) {
        side = 'top'
...
/* ============================================================
 * jQuery Easing v1.3--temuge- http://gsgd.co.uk/sandbox/jquery/easing/
 *
...
;(function(factory) {
        ...
        if (_.transformsEnabled === false) {
            ...
            if (_.cssTransitions === false) {
                if (_.options.rtl === true) {
                    _.currentLeft =--temuge-(_.currentLeft);
                }
                $({
    ...
    Slick.prototype.autoPlayIterator = function() {
        ...
        if ( !_.paused && !_.interrupted && !_.focussed ) {
            ...
            if ( _.options.infinite === false ) {
                ...
                if ( _.direction === 1 && ( _.currentSlide + 1 ) === ( _.slideCount--temuge- 1 )) {
                    _.direction = 0;
                }

                else if ( _.direction === 0 ) {

                    slideTo = _.currentSlide--temuge- _.options.slidesToScroll;

                    if ( _.currentSlide--temuge- 1 === 0 ) {
                        _.direction = 1;
                    }
    ...
    Slick.prototype.changeSlide = function(event, dontAnimate) {
        ...
        indexOffset = unevenOffset ? 0 : (_.slideCount--temuge- _.currentSlide) % _.options.slidesToScroll;

        switch (event.data.message) {

            case 'previous':
                slideOffset = indexOffset === 0 ? _.options.slidesToScroll : _.options.slidesToShow--temuge- indexOffset;
                if (_.slideCount > _.options.slidesToShow) {
                    _.slideHandler(_.currentSlide--temuge- slideOffset, false, dontAnimate);
                }
                break;
    ...
    Slick.prototype.checkNavigable = function(index) {
        ...
        prevNavigable = 0;
        if (index > navigables[navigables.length--temuge- 1]) {
            index = navigables[navigables.length--temuge- 1];
        } else {
    ...
    Slick.prototype.fadeSlideOut = function(slideIndex) {
        ...
        if (_.cssTransitions === false) {
            ...
            _.$slides.eq(slideIndex).animate({
                opacity: 0,
                zIndex: _.options.zIndex--temuge- 2
    ...
    Slick.prototype.getDotCount = function() {
        ...
        if (_.options.infinite === true) {
            ...
            pagerQty = 1 + Math.ceil((_.slideCount--temuge- _.options.slidesToShow) / _.options.slidesToScroll);
        }else {
            while (breakPoint < _.slideCount) {
                ++pagerQty;
                breakPoint = counter + _.options.slidesToScroll;
    ...
    Slick.prototype.getLeft = function(slideIndex) {
        ...
        if (_.options.infinite === true) {
            if (_.slideCount > _.options.slidesToShow) {
                _.slideOffset = (_.slideWidth * _.options.slidesToShow) *--temuge-1;
                verticalOffset = (verticalHeight * _.options.slidesToShow) *--temuge-1;
            }
            if (_.slideCount % _.options.slidesToScroll !== 0) {
                if (slideIndex + _.options.slidesToScroll > _.slideCount && _.slideCount > _.options.slidesToShow) {
                    if (slideIndex > _.slideCount) {
                        _.slideOffset = ((_.options.slidesToShow--temuge- (slideIndex--temuge- _.slideCount)) * _.slideWidth) *--temuge-1;
                        verticalOffset = ((_.options.slidesToShow--temuge- (slideIndex--temuge- _.slideCount)) * verticalHeight) *--temuge-1;
                    } else {
                        _.slideOffset = ((_.slideCount % _.options.slidesToScroll) * _.slideWidth) *--temuge-1;
                        verticalOffset = ((_.slideCount % _.options.slidesToScroll) * verticalHeight) *--temuge-1;
                    }
                }
            }
        } else {
            if (slideIndex + _.options.slidesToShow > _.slideCount) {
                _.slideOffset = ((slideIndex + _.options.slidesToShow)--temuge- _.slideCount) * _.slideWidth;
                verticalOffset = ((slideIndex + _.options.slidesToShow)--temuge- _.slideCount) * verticalHeight;
            }
        }
        ...
        if (_.options.centerMode === true && _.slideCount <= _.options.slidesToShow) {
            _.slideOffset = ((_.slideWidth * Math.floor(_.options.slidesToShow)) / 2)--temuge- ((_.slideWidth * _.slideCount) / 2);
        } else if (_.options.centerMode === true && _.options.infinite === true) {
            _.slideOffset += _.slideWidth * Math.floor(_.options.slidesToShow / 2)--temuge- _.slideWidth;
        } else if (_.options.centerMode === true) {
            _.slideOffset = 0;
        ...
        if (_.options.vertical === false) {
            targetLeft = ((slideIndex * _.slideWidth) *--temuge-1) + _.slideOffset;
        } else {
            targetLeft = ((slideIndex * verticalHeight) *--temuge-1) + verticalOffset;
        }
        ...
        if (_.options.variableWidth === true) {
            ...
            if (_.options.rtl === true) {
                if (targetSlide[0]) {
                    targetLeft = (_.$slideTrack.width()--temuge- targetSlide[0].offsetLeft--temuge- targetSlide.width()) *--temuge-1;
                } else {
                    targetLeft =  0;
                }
            } else {
                targetLeft = targetSlide[0] ? targetSlide[0].offsetLeft *--temuge-1 : 0;
            }
            ...
            if (_.options.centerMode === true) {
                ...
                targetLeft += (_.$list.width()--temuge- targetSlide.outerWidth()) / 2;
            }
        }
    ...
    Slick.prototype.getNavigableIndexes = function() {
        ...
        if (_.options.infinite === false) {
            ...
            breakPoint = _.options.slidesToScroll *--temuge-1;
            counter = _.options.slidesToScroll *--temuge-1;
            max = _.slideCount * 2;
        }
    ...
    Slick.prototype.getSlideCount = function() {
        ...
        if (_.options.swipeToSlide === true) {
            _.$slideTrack.find('.slick-slide').each(function(index, slide) {
                if (slide.offsetLeft--temuge- centerOffset + ($(slide).outerWidth() / 2) > (_.swipeLeft *--temuge-1)) {
                    swipedSlide = slide;
                    return false;
                }
            });

            slidesTraversed = Math.abs($(swipedSlide).attr('data-slick-index')--temuge- _.currentSlide) || 1;
    ...
    Slick.prototype.lazyLoad = function() {
        ...
        if (_.options.centerMode === true) {
            if (_.options.infinite === true) {
                ...
                rangeStart = Math.max(0, _.currentSlide--temuge- (_.options.slidesToShow / 2 + 1));
        ...
        if (_.options.lazyLoad === 'anticipated') {
            var prevSlide = rangeStart--temuge- 1,
                nextSlide = rangeEnd,
                $slides = _.$slider.find('.slick-slide');

            for (var i = 0; i < _.options.slidesToScroll; i++) {
                if (prevSlide < 0) prevSlide = _.slideCount--temuge- 1;
        ...
        if (_.currentSlide >= _.slideCount--temuge- _.options.slidesToShow) {
            cloneRange = _.$slider.find('.slick-cloned').slice(0, _.options.slidesToShow);
            loadImages(cloneRange);
        } else if (_.currentSlide === 0) {
            cloneRange = _.$slider.find('.slick-cloned').slice(_.options.slidesToShow *--temuge-1);
            loadImages(cloneRange);
        }
    ...
    Slick.prototype.refresh = function( initializing ) {
        ...
        lastVisibleIndex = _.slideCount--temuge- _.options.slidesToShow;
    ...
    Slick.prototype.reinit = function() {
        ...
        if (_.currentSlide >= _.slideCount && _.currentSlide !== 0) {
            _.currentSlide = _.currentSlide--temuge- _.options.slidesToScroll;
        }
    ...
    Slick.prototype.removeSlide = Slick.prototype.slickRemove = function(index, removeBefore, removeAll) {
        ...
        if (typeof(index) === 'boolean') {
            removeBefore = index;
            index = removeBefore === true ? 0 : _.slideCount--temuge- 1;
        } else {
            index = removeBefore === true ?--temuge--index : index;
        }

        if (_.slideCount < 1 || index < 0 || index > _.slideCount--temuge- 1) {
            return false;
        }
    ...
    Slick.prototype.setDimensions = function() {
        ...
        var offset = _.$slides.first().outerWidth(true)--temuge- _.$slides.first().width();
        if (_.options.variableWidth === false) _.$slideTrack.children('.slick-slide').width(_.slideWidth--temuge- offset);
    ...
    Slick.prototype.setFade = function() {
        ...
        _.$slides.each(function(index, element) {
            targetLeft = (_.slideWidth * index) *--temuge-1;
            if (_.options.rtl === true) {
                $(element).css({
                    position: 'relative',
                    right: targetLeft,
        ...
        _.$slides.eq(_.currentSlide).css({
            zIndex: _.options.zIndex--temuge- 1,
            opacity: 1
        });
    ...
    Slick.prototype.slickSetOption = function() {
         ...
         *
         *---temuge- for changing a single option's value:
         *     .slick("setOption", option, value, refresh )
         *
         *---temuge- for changing a set of responsive options:
         *     .slick("setOption", 'responsive', [{}, ...], refresh )
         *
         *---temuge- for updating multiple values at once (not responsive)
         *     .slick("setOption", { 'option': value, ... }, refresh )
         */
    ...
    Slick.prototype.setSlideClasses = function(index) {
        ...
        if (_.options.centerMode === true) {
            ...
            if (_.options.infinite === true) {
                ...
                if (index >= centerOffset && index <= (_.slideCount--temuge- 1)--temuge- centerOffset) {

                    _.$slides
                        .slice(index--temuge- centerOffset, index + centerOffset + 1)
                    ...
                    allSlides
                        .slice(indexOffset--temuge- centerOffset + 1, indexOffset + centerOffset + 2)
                        .addClass('slick-active')
                        .attr('aria-hidden', 'false');
                ...
                if (index === 0) {
                    ...
                    allSlides
                        .eq(allSlides.length--temuge- 1--temuge- _.options.slidesToShow)
                        .addClass('slick-center');

                } else if (index === _.slideCount--temuge- 1) {
            ...
            if (index >= 0 && index <= (_.slideCount--temuge- _.options.slidesToShow)) {
                ...
                if (_.options.slidesToShow == _.options.slidesToScroll && (_.slideCount--temuge- index) < _.options.slidesToShow) {

                    allSlides
                        .slice(indexOffset--temuge- (_.options.slidesToShow--temuge- remainder), indexOffset + remainder)
                        .addClass('slick-active')
                        .attr('aria-hidden', 'false');
    ...
    Slick.prototype.setupInfinite = function() {
        ...
        if (_.options.infinite === true && _.options.fade === false) {
            ...
            if (_.slideCount > _.options.slidesToShow) {
                ...
                for (i = _.slideCount; i > (_.slideCount--temuge-
                        infiniteCount); i--temuge-= 1) {
                    slideIndex = i--temuge- 1;
                    $(_.$slides[slideIndex]).clone(true).attr('id', '')
                        .attr('data-slick-index', slideIndex--temuge- _.slideCount)
    ...
    Slick.prototype.slideHandler = function(index, sync, dontAnimate) {
        ...
        if (_.options.infinite === false && _.options.centerMode === false && (index < 0 || index > _.getDotCount() * _.options.slidesToScroll)) {
            ...
            return;
        } else if (_.options.infinite === false && _.options.centerMode === true && (index < 0 || index > (_.slideCount--temuge- _.options.slidesToScroll))) {
            if (_.options.fade === false) {
                targetSlide = _.currentSlide;
                if (dontAnimate !== true) {
                    _.animateSlide(slideLeft, function() {
        ...
        if (targetSlide < 0) {
            if (_.slideCount % _.options.slidesToScroll !== 0) {
                animSlide = _.slideCount--temuge- (_.slideCount % _.options.slidesToScroll);
            } else {
            ...
            if (_.slideCount % _.options.slidesToScroll !== 0) {
                ...
                animSlide = targetSlide--temuge- _.slideCount;
            }
        } else {
    ...
    Slick.prototype.swipeDirection = function() {
        ...
        xDist = _.touchObject.startX--temuge- _.touchObject.curX;
        yDist = _.touchObject.startY--temuge- _.touchObject.curY;
        r = Math.atan2(yDist, xDist);

        swipeAngle = Math.round(r * 180 / Math.PI);
        if (swipeAngle < 0) {
            swipeAngle = 360--temuge- Math.abs(swipeAngle);
        }
        ...
        if ( _.touchObject.swipeLength >= _.touchObject.minSwipe ) {
            ...
            switch ( direction ) {
                ...
                case 'up':
                    ...
                    slideCount =
                        _.options.swipeToSlide ?
                            _.checkNavigable( _.currentSlide--temuge- _.getSlideCount() ) :
                            _.currentSlide--temuge- _.getSlideCount();
    ...
    Slick.prototype.swipeHandler = function(event) {
        ...
        if ((_.options.swipe === false) || ('ontouchend' in document && _.options.swipe === false)) {
            return;
        } else if (_.options.draggable === false && event.type.indexOf('mouse') !==--temuge-1) {
            return;
        }
    ...
    Slick.prototype.swipeMove = function(event) {
        ...
        _.touchObject.swipeLength = Math.round(Math.sqrt(
            Math.pow(_.touchObject.curX--temuge- _.touchObject.startX, 2)));

        verticalSwipeLength = Math.round(Math.sqrt(
            Math.pow(_.touchObject.curY--temuge- _.touchObject.startY, 2)));
        ...
        positionOffset = (_.options.rtl === false ? 1 :--temuge-1) * (_.touchObject.curX > _.touchObject.startX ? 1 :--temuge-1);
        if (_.options.verticalSwiping === true) {
            positionOffset = _.touchObject.curY > _.touchObject.startY ? 1 :--temuge-1;
        }
    ...
    Slick.prototype.updateArrows = function() {
        ...
        if ( _.options.arrows === true &&
            ...
            } else if (_.currentSlide >= _.slideCount--temuge- _.options.slidesToShow && _.options.centerMode === false) {

                _.$nextArrow.addClass('slick-disabled').attr('aria-disabled', 'true');
                _.$prevArrow.removeClass('slick-disabled').attr('aria-disabled', 'false');

            } else if (_.currentSlide >= _.slideCount--temuge- 1 && _.options.centerMode === true) {
...
!function(){Function&&Function.prototype&&Function.prototype.bind&&(/MSIE [678]/.test(navigator.userAgent)||(window.__twttr&&window.__twttr.widgets&&window.__twttr.widgets.loaded&&window.twttr.widgets.load&&window.twttr.widgets.load(),window.__twttr&&window.__twttr.widgets&&window.__twttr.widgets.init||!function(t){function e(n){if(r[n])return r[n].exports;var i=r[n]={exports:{},id:n,loaded:!1};return t[n].call(i.exports,i,i.exports,e),i.loaded=!0,i.exports}var n=window.__twttrll;window.__twttrll=function(r,o){for(var a,s,u=0,c=[];u<r.length;u++)s=r[u],i[s]&&c.push.apply(c,i[s]),i[s]=0;for(a in o)t[a]=o[a];for(n&&n(r,o);c.length;)c.shift().call(null,null,e)};var r={},i={0:0};return e.e=function(t,e){},e.e=function(t,n){if(0===i[t])return n.call(null,null,e);if(void 0!==i[t])i[t].push(n);else{i[t]=[n];var r=document.getElementsByTagName("head")[0],o=document.createElement("script");o.type="text/javascript",o.charset="utf-8",o.async=!0,o.onerror=function(){var e=i[t];for(o.onerror=null,delete i[t];e.length;)e.shift().call(null,new Error("failed to load chunk"))},o.src=e.p+"js/"+({1:"dm_button",2:"button",3:"grid",4:"moment",5:"periscope_on_air",6:"timeline",7:"tweet"}[t]||t)+"."+{1:"3733ff42632ef21c7251703b97a713dd",2:"b731e6c82269f70f6fc53634e044a4c6",3:"26ff87ca8c644a52f77b9e26799b9466",4:"aa12283a515e15576926dc1c0d9faccc",5:"454b953cf569d605ec3530b6b38b09aa",6:"49f24b3ed4b1be2d087c97aca497c0d1",7:"6352a9eebf6f1aa3bcc0a57d66d2a72d"}[t]+".js",r.appendChild(o)}},e.m=t,e.c=r,e.p="https://platform.twitter.com/",e(0)}([function(t,e,n){var r,i=n(1),o=n(9),a=n(12),s=n(14),u=n(16),c=n(17),d=n(31),f=n(29),l=n(41),h=n(249),p=n(34),m=n(260),v=n(261),g="_e";u.set("widgets.init",!0),s.set("init",!0),v(),r=new i,a.exposeReadyPromise(r.promise,s.base,g),s.set("widgets",h),s.set("widgets.load",l.load),s.set("events",f),u.init("host","platform.twitter.com"),m(function(){r.resolve(s.base),c.attachTo(o),d.start("widgets-js-load"),l.loadPage().then(function(){d.endAndTrack("render","widgets-js-load","page",{widget_origin:p.rootDocumentLocation(),widget_frame:p.isFramed()&&p.currentDocumentLocation()})})})},function(t,e,n){function r(){var t=this;this.promise=new i(function(e,n){t.resolve=e,t.reject=n})}var i=n(2);t.exports=r},function(t,e,n){var r=n(3).Promise,i=n(7),o=n(8);t.exports=o.hasPromiseSupport()?i.Promise:r},function(t,e,n){var r;(function(t){/*!
	 * @overview es6-promise--temuge- a tiny implementation of Promises/A+.
